              ...
              <div className="p-5 sm:p-6 md:p-8 bg-white rounded-xl">
                ...
                <div className="space-y-2">
                  <ContactInfoItem
                    ...
                    title="Email Address"
                    value="info@haventutor.comtutor.com"
                  />
                  <ContactInfoItem
                    icon={<Globe className="w-5 h-5 sm:w-6 sm:h-6" />}
                    title="Website"
                    value="www.haventutor.comtutor.com"
                  />
                  <ContactInfoItem
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3">
                    <a
                      href="https://www.facebook.com/haventutor.comtutors"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Facebook"
                    ...
                    <a
                      href="https://www.instagram.com/haventutor.com__tutors?igsh=MXRrcmk4OGtuYTJveA=="
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      href="https://wa.me/+919606840892?text=Hello%20haventutor.com%20Tutors!%20I%20would%20like%20to%20learn%20more%20about%20your%20tutoring%20services."
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="WhatsApp"
                    ...
                    <a
                      href="https://youtube.com/@haventutor.comtutors?si=q8Tr5bEIqM0NHExY"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="YouTube"
